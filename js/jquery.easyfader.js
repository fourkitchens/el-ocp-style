			...
			return this.each(function(){
				...
				function animateSlides(activeNdx, newNdx){
					function cleanUp(){
						...
						$slides.eq(activeNdx).removeStyle(prefix+'transition, transition, opacity, z-index');
					...
					if(!prefix){
					  ...
					  // Set up the new slide styles
						var stylesNew = {};
						stylesNew[prefix+'transition'] = 'opacity '+config.fadeDur+'ms';
						stylesNew['opacity'] = 1;
						$slides.eq(newNdx).css(stylesNew);
					  // Set up the active slide styles
						var stylesActive = {};
						stylesActive[prefix+'transition'] = 'opacity '+config.fadeDur+'ms';
						stylesActive['opacity'] = 0;
						$slides.eq(activeNdx).css(stylesActive);
